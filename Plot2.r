{
## Plot 2 for Project for Week 1 of Coursera's "Exploratory Data Analysis" - Histogram
  ## Instructions:
  ...
  plot(x=as.numeric(ds2$Global_active_power),y = ds2$Dayofwk, type = "l",axes=FALSE, ann=FALSE,ylab = "Global Active Power (kilowatts)", xlab="")
  ...
  plot(x=as.numeric(ds2$Global_active_power),y = ds2$Dayofwk, type = "l",axes=FALSE,,ylab = "Global Active Power (kilowatts)", xlab="")
